...
class RestrictedTapTwo: UIViewController, WKNavigationDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "\(defaults.object(forKey: "URLTab2") as! String)")!
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "grabURL2"), object: self)
        let defaults: UserDefaults = UserDefaults.standard
        defaults.set("\(webView.url!)", forKey: "URLTab2")
        defaults.set("\(webView.title!)", forKey: "URLTitleTab2")
